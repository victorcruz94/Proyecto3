  ...
  <script type="text/javascript">
    function avisoEliminar(){
      if(confirm('¿Deseas eliminar este usuario?')){
        ...
        document.formularioEliminar.stop();
      }
    }
  </script>
</head>
<header>
  ...
  <section>
    ...
    <button id='boton' type="submit" class="button" onclick="window.location.href='pagina_principal_root.php?id=<?php echo $_REQUEST['identif_usuario']; ?>'">INICIO</button>
  </section>
</header>
<!-- ############################################################ -->
<body id='bg'>
  <section>
    ...
    <section id="formulario">
      ...
      <?php
        ...
        $buscarUsuarios="SELECT * FROM usuario WHERE tipo_usuario!='root'";
        ...
        echo "</table>";
        echo "<button><a href='afegir_users.php?identif_usuario=$idUser'><i class='fa fa-user-plus'></i></a><b/button>";
        mysqli_close($con);
      ?>
      </article>
